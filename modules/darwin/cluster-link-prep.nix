...
in
{
  ...
  config = lib.mkIf cfg.enable {
    ...
    environment.etc."sudoers.d/cluster-wired-limit" =
      lib.mkIf (cfg.clusterWiredLimitMb != null)
        {
          text = ''
    ...
    system.activationScripts.postActivation.text = lib.mkAfter ''
      CLUSTER_LINK_IP=${lib.escapeShellArg cfg.linkIps.${cfg.role}} ${lib.getExe prepPkg} || echo "cluster-link-prep: non-fatal failure (see log above)"
