...
in
{
  ...
  # services named below, skipping any a host does not have. With the list
  # empty, activation asserts nothing about resolvers at all, so a resolver set
  # locally on an interface persists across every rebuild.
  #
